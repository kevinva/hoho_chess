...
# 限制多少步还没分出胜负，则平手
RESTRICT_ROUND_NUM = 120

# 自博弈时的限制步数
SELF_BATTLE_RESTRICT_ROUND_NUM = 120

# 网络训练完成后自博弈的次数
SELF_BATTLE_NUM = 400

# 训练的网络与当前网络的自博弈，超过该阈值即替换当前网络
SELF_BATTLE_WIN_RATE = 0.5  #0.55
...
REPLAY_BUFFER_FILE_PREFIX = 'replay_buffer_u'
MODEL_FILE_PREFIX = 'hoho_agent_u'